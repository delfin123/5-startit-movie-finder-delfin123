...
describe('Authorization page',async function(){
    ...
    describe('When user login with valid account and password', async function () {
        fit('he must login successfully', async function () {
        ...
        it('should have rating', async function () {
            ...
            expect(await rating).not.to.be.empty                            //received value of raiting mustn't to be empty
            logger.info('The rating of film is '+ await rating)            //Output the received value of the rating in the console
        })

        it('should have similar movies block with at least one movie', async function () {
            ...
            logger.info('Искомый фильм включает такие жанры ' + genresoffilm)                     //and output them in the console
            ...
            logger.info('Подобный фильм включает такие жанры '+ genresofsimilarfilm)                      //and output them to the console
            expect(await homepage.compare2Massives(genresoffilm,genresofsimilarfilm)).not.to.be.empty                                //received arr 3 must not be empty
            logger.info('Фильмы совпадают по таким жанрам: '+ await homepage.compare2Massives(genresoffilm,genresofsimilarfilm))     //and bring to the console genres for which the movies match
        })
    ...
    describe('reviews block', function () {
        it('should contain at least one review', async function () {
    ...
    describe('Popular series', async function () {
        it("shouldn't have search bar", async function () {
